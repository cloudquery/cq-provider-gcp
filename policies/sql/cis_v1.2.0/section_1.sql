...
\i sql/views/project_policy_members.sql
...
\i sql/queries/iam/managed_service_account_keys.sql
\set check_id "1.5"
\echo "Executing check 1.5"
\i sql/queries/iam/service_account_admin_priv.sql
\set check_id "1.6"
\echo "Executing check 1.6"
\i sql/queries/iam/users_with_service_account_token_creator_role.sql
\set check_id "1.7"
\echo "Executing check 1.7"
\i sql/queries/iam/service_account_keys_not_rotated.sql
\set check_id "1.8"
\echo "Executing check 1.8"
\i sql/queries/iam/seperation_of_duties.sql
\set check_id "1.9"
\echo "Executing check 1.9"
\i sql/queries/kms/publicly_accessible.sql
\set check_id "1.10"
\echo "Executing check 1.10"
\i sql/queries/kms/keys_not_rotated_within_90_days.sql
\set check_id "1.11"
\echo "Executiong check 1.11"
\i sql/queries/iam/kms_seperation_of_duties.sql
-- MANUAL
\set check_id "1.12"
