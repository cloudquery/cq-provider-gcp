...
const alertPoliciesTableName = "gcp_monitoring_alert_policies"

func MonitoringAlertPolicies() *schema.Table {
	return &schema.Table{
		Name:         alertPoliciesTableName,
		...
		Multiplex:    client.ProjectMultiplex(alertPoliciesTableName, client.MonitoringService),
