...
const backendServicesTableName = "gcp_compute_backend_services"

func ComputeBackendServices() *schema.Table {
	return &schema.Table{
		Name:         backendServicesTableName,
		...
		Multiplex:    client.ProjectMultiplex(backendServicesTableName, client.ComputeService),
