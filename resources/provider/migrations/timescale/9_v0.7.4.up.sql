...
CREATE TABLE IF NOT EXISTS "gcp_kubernetes_clusters" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	...
	"zone" text,
	CONSTRAINT gcp_kubernetes_clusters_pk PRIMARY KEY(cq_fetch_date,id),
	UNIQUE(cq_fetch_date,cq_id)
);
SELECT setup_tsdb_parent('gcp_kubernetes_clusters');
CREATE TABLE IF NOT EXISTS "gcp_kubernetes_cluster_autoscaling_resource_limits" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cq_fetch_date" timestamp without time zone NOT NULL,
	"cluster_cq_id" uuid,
	...
	"minimum" bigint,
	"resource_type" text,
	CONSTRAINT gcp_kubernetes_cluster_autoscaling_resource_limits_pk PRIMARY KEY(cq_fetch_date,cq_id),
	UNIQUE(cq_fetch_date,cq_id)
);
CREATE INDEX ON gcp_kubernetes_cluster_autoscaling_resource_limits (cq_fetch_date, cluster_cq_id);
SELECT setup_tsdb_child('gcp_kubernetes_cluster_autoscaling_resource_limits', 'cluster_cq_id', 'gcp_kubernetes_clusters', 'cq_id');
CREATE TABLE IF NOT EXISTS "gcp_kubernetes_cluster_conditions" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cq_fetch_date" timestamp without time zone NOT NULL,
	"cluster_cq_id" uuid,
	...
	"code" text,
	"message" text,
	CONSTRAINT gcp_kubernetes_cluster_conditions_pk PRIMARY KEY(cq_fetch_date,cq_id),
	UNIQUE(cq_fetch_date,cq_id)
);
CREATE INDEX ON gcp_kubernetes_cluster_conditions (cq_fetch_date, cluster_cq_id);
SELECT setup_tsdb_child('gcp_kubernetes_cluster_conditions', 'cluster_cq_id', 'gcp_kubernetes_clusters', 'cq_id');
CREATE TABLE IF NOT EXISTS "gcp_kubernetes_cluster_master_authorized_networks_cidr_blocks" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cq_fetch_date" timestamp without time zone NOT NULL,
	"cluster_cq_id" uuid,
	"cidr_block" cidr,
	"display_name" text,
	CONSTRAINT gcp_kubernetes_cluster_master_authorized_networks_cidr_block_pk PRIMARY KEY(cq_fetch_date,cq_id),
	UNIQUE(cq_fetch_date,cq_id)
);
CREATE INDEX ON gcp_kubernetes_cluster_master_authorized_networks_cidr_blocks (cq_fetch_date, cluster_cq_id);
SELECT setup_tsdb_child('gcp_kubernetes_cluster_master_authorized_networks_cidr_blocks', 'cluster_cq_id', 'gcp_kubernetes_clusters', 'cq_id');
CREATE TABLE IF NOT EXISTS "gcp_kubernetes_cluster_node_pools" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cq_fetch_date" timestamp without time zone NOT NULL,
	"cluster_cq_id" uuid,
	...
	"version" text,
	CONSTRAINT gcp_kubernetes_cluster_node_pools_pk PRIMARY KEY(cq_fetch_date,cq_id),
	UNIQUE(cq_fetch_date,cq_id)
);
CREATE INDEX ON gcp_kubernetes_cluster_node_pools (cq_fetch_date, cluster_cq_id);
SELECT setup_tsdb_child('gcp_kubernetes_cluster_node_pools', 'cluster_cq_id', 'gcp_kubernetes_clusters', 'cq_id');
CREATE TABLE IF NOT EXISTS "gcp_kubernetes_cluster_node_pool_conditions" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cq_fetch_date" timestamp without time zone NOT NULL,
	...
	"code" text,
	"message" text,
	CONSTRAINT gcp_kubernetes_cluster_node_pool_conditions_pk PRIMARY KEY(cq_fetch_date,cq_id),
	UNIQUE(cq_fetch_date,cq_id)
);
CREATE INDEX ON gcp_kubernetes_cluster_node_pool_conditions (cq_fetch_date, cluster_node_pool_cq_id);
SELECT setup_tsdb_child('gcp_kubernetes_cluster_node_pool_conditions', 'cluster_node_pool_cq_id', 'gcp_kubernetes_cluster_node_pools', 'cq_id');
CREATE TABLE IF NOT EXISTS "gcp_kubernetes_cluster_node_pool_config_taints" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cq_fetch_date" timestamp without time zone NOT NULL,
	"cluster_node_pool_cq_id" uuid,
	...
	"key" text,
	"value" text,
	CONSTRAINT gcp_kubernetes_cluster_node_pool_config_taints_pk PRIMARY KEY(cq_fetch_date,cq_id),
	UNIQUE(cq_fetch_date,cq_id)
);
CREATE INDEX ON gcp_kubernetes_cluster_node_pool_config_taints (cq_fetch_date, cluster_node_pool_cq_id);
SELECT setup_tsdb_child('gcp_kubernetes_cluster_node_pool_config_taints', 'cluster_node_pool_cq_id', 'gcp_kubernetes_cluster_node_pools', 'cq_id');
