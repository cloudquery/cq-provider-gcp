-- Autogenerated by migration tool on 2022-05-22 15:40:12
...
CREATE TABLE IF NOT EXISTS "gcp_container_cluster_master_authorized_networks_config_cidr_blocks" (
	...
	"cidr_block" cidr,
	"display_name" text,
	CONSTRAINT gcp_container_cluster_master_authorized_networks_config_cidr_pk PRIMARY KEY(cq_fetch_date,cq_id),
	UNIQUE(cq_fetch_date,cq_id)
);
CREATE INDEX ON gcp_container_cluster_master_authorized_networks_config_cidr_blocks (cq_fetch_date, cluster_cq_id);
SELECT setup_tsdb_child('gcp_container_cluster_master_authorized_networks_config_cidr_blocks', 'cluster_cq_id', 'gcp_container_clusters', 'cq_id');
