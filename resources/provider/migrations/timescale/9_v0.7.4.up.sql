...
CREATE TABLE IF NOT EXISTS "gcp_container_clusters" (
	...
	"zone" text,
	CONSTRAINT gcp_container_clusters_pk PRIMARY KEY(cq_fetch_date,id),
	UNIQUE(cq_fetch_date,cq_id)
);
SELECT setup_tsdb_parent('gcp_container_clusters');
CREATE TABLE IF NOT EXISTS "gcp_container_cluster_autoscaling_resource_limits" (
	...
	"minimum" bigint,
	"resource_type" text,
	CONSTRAINT gcp_container_cluster_autoscaling_resource_limits_pk PRIMARY KEY(cq_fetch_date,cq_id),
	UNIQUE(cq_fetch_date,cq_id)
);
CREATE INDEX ON gcp_container_cluster_autoscaling_resource_limits (cq_fetch_date, cluster_cq_id);
SELECT setup_tsdb_child('gcp_container_cluster_autoscaling_resource_limits', 'cluster_cq_id', 'gcp_container_clusters', 'cq_id');
CREATE TABLE IF NOT EXISTS "gcp_container_cluster_conditions" (
	...
	"code" text,
	"message" text,
	CONSTRAINT gcp_container_cluster_conditions_pk PRIMARY KEY(cq_fetch_date,cq_id),
	UNIQUE(cq_fetch_date,cq_id)
);
CREATE INDEX ON gcp_container_cluster_conditions (cq_fetch_date, cluster_cq_id);
SELECT setup_tsdb_child('gcp_container_cluster_conditions', 'cluster_cq_id', 'gcp_container_clusters', 'cq_id');
CREATE TABLE IF NOT EXISTS "gcp_container_cluster_master_authorized_networks_cidr_blocks" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cq_fetch_date" timestamp without time zone NOT NULL,
	"cluster_cq_id" uuid,
	"cidr_block" cidr,
	"display_name" text,
	CONSTRAINT gcp_container_cluster_master_authorized_networks_cidr_blocks_pk PRIMARY KEY(cq_fetch_date,cq_id),
	UNIQUE(cq_fetch_date,cq_id)
);
CREATE INDEX ON gcp_container_cluster_master_authorized_networks_cidr_blocks (cq_fetch_date, cluster_cq_id);
SELECT setup_tsdb_child('gcp_container_cluster_master_authorized_networks_cidr_blocks', 'cluster_cq_id', 'gcp_container_clusters', 'cq_id');
CREATE TABLE IF NOT EXISTS "gcp_container_cluster_node_pools" (
	...
	"version" text,
	CONSTRAINT gcp_container_cluster_node_pools_pk PRIMARY KEY(cq_fetch_date,cq_id),
	UNIQUE(cq_fetch_date,cq_id)
);
CREATE INDEX ON gcp_container_cluster_node_pools (cq_fetch_date, cluster_cq_id);
SELECT setup_tsdb_child('gcp_container_cluster_node_pools', 'cluster_cq_id', 'gcp_container_clusters', 'cq_id');
CREATE TABLE IF NOT EXISTS "gcp_container_cluster_node_pool_conditions" (
	...
	"code" text,
	"message" text,
	CONSTRAINT gcp_container_cluster_node_pool_conditions_pk PRIMARY KEY(cq_fetch_date,cq_id),
	UNIQUE(cq_fetch_date,cq_id)
);
CREATE INDEX ON gcp_container_cluster_node_pool_conditions (cq_fetch_date, cluster_node_pool_cq_id);
SELECT setup_tsdb_child('gcp_container_cluster_node_pool_conditions', 'cluster_node_pool_cq_id', 'gcp_container_cluster_node_pools', 'cq_id');
CREATE TABLE IF NOT EXISTS "gcp_container_cluster_node_pool_config_taints" (
	...
	"key" text,
	"value" text,
	CONSTRAINT gcp_container_cluster_node_pool_config_taints_pk PRIMARY KEY(cq_fetch_date,cq_id),
	UNIQUE(cq_fetch_date,cq_id)
);
CREATE INDEX ON gcp_container_cluster_node_pool_config_taints (cq_fetch_date, cluster_node_pool_cq_id);
SELECT setup_tsdb_child('gcp_container_cluster_node_pool_config_taints', 'cluster_node_pool_cq_id', 'gcp_container_cluster_node_pools', 'cq_id');
