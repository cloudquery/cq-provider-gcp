-- Autogenerated by migration tool on 2022-05-23 15:04:10
...
CREATE TABLE IF NOT EXISTS "gcp_kubernetes_clusters" (
	...
	"zone" text,
	CONSTRAINT gcp_kubernetes_clusters_pk PRIMARY KEY(id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_kubernetes_cluster_autoscaling_resource_limits" (
	...
	"minimum" bigint,
	"resource_type" text,
	CONSTRAINT gcp_kubernetes_cluster_autoscaling_resource_limits_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (cluster_cq_id) REFERENCES gcp_kubernetes_clusters(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_kubernetes_cluster_conditions" (
	...
	"code" text,
	"message" text,
	CONSTRAINT gcp_kubernetes_cluster_conditions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (cluster_cq_id) REFERENCES gcp_kubernetes_clusters(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_kubernetes_cluster_master_authorized_networks_cidr_blocks" (
	...
	"cidr_block" cidr,
	"display_name" text,
	CONSTRAINT gcp_kubernetes_cluster_master_authorized_networks_cidr_block_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (cluster_cq_id) REFERENCES gcp_kubernetes_clusters(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_kubernetes_cluster_node_pools" (
	...
	"version" text,
	CONSTRAINT gcp_kubernetes_cluster_node_pools_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (cluster_cq_id) REFERENCES gcp_kubernetes_clusters(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_kubernetes_cluster_node_pool_conditions" (
	...
	"code" text,
	"message" text,
	CONSTRAINT gcp_kubernetes_cluster_node_pool_conditions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (cluster_node_pool_cq_id) REFERENCES gcp_kubernetes_cluster_node_pools(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_kubernetes_cluster_node_pool_config_taints" (
	...
	"key" text,
	"value" text,
	CONSTRAINT gcp_kubernetes_cluster_node_pool_config_taints_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (cluster_node_pool_cq_id) REFERENCES gcp_kubernetes_cluster_node_pools(cq_id) ON DELETE CASCADE
);
